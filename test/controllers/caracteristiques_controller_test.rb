...
class CaracteristiquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create caracteristique" do
    assert_difference('Caracteristique.count') do
      post caracteristiques_url, params: { caracteristique: { name: @caracteristique.name, site_id: @caracteristique.site_id } }
    end
  ...
  test "should update caracteristique" do
    patch caracteristique_url(@caracteristique), params: { caracteristique: { name: @caracteristique.name, site_id: @caracteristique.site_id } }
