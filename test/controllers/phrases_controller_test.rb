...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { caracteristique_id: @phrase.caracteristique_id, lang: @phrase.lang, libelle: @phrase.libelle } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { caracteristique_id: @phrase.caracteristique_id, lang: @phrase.lang, libelle: @phrase.libelle } }
